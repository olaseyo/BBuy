                ...
                <table id="tableExport" class="display table table-hover table-checkable order-column width-per-100" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo url('admin_edit_sub_category/')."/".$data->sub_cat_id ?>"class="btn tblActnBtn">
                          <i class="material-icons">mode_edit</i>
                        </a>
                      </td>
                      <td>
                        <button id="del_btn{{$data->sub_cat_id}}" onclick="Delete({{ $data->sub_cat_id}},'del_btn{{$data->sub_cat_id}}','DeleteSubCategory')" class="btn tblActnBtn">
