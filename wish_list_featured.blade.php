            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                ...
                <form class="form_validation<?php echo $product_data->product_id ?>" method="post">
                  ...
                  <div class="single-input-item">
                    <button type="button" onclick="Submit('form_validation<?php echo $product_data->product_id ?>')" id="submit_btn" class="sqr-btn btn btn-block">Add to wish list <img id="loader" class="loader" src="{{url('admin/assets/images/ripple.gif')}}" /></button>
                  </div>
                </form>
