                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" value="<?php echo $categories_list[0]->cat_name; ?>" name="cat_name" >
                                        <label class="form-label">Category Name</label>
                                          <input type="hidden" class="form-control" value="<?php echo $categories_list[0]->cat_id; ?>" name="cat_id" >
                                    </div>
                                </div>
