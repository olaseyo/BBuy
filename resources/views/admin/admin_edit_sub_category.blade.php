...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  <ul class="breadcrumb breadcrumb-style ">
    ...
    <li class="breadcrumb-item active">Edi Sub Category</li>
  </ul>
</div>
</div>
</div>
      ...
      <div class="form-group form-float">
          <div class="form-line">
              <select name="cat_id" class="form-control" >
                    <option value="{{$categories_list[0]->cat_id}}"> {{$categories_list[0]->cat_name}}</option>
                    <?php foreach($categories_list2 as $category){ ?>
                <option value="<?php echo $category->cat_id ?>"> <?php echo $category->cat_name?></option>
                <?php  }  ?>
              </select>

              <label class="form-label">Category Name</label>
                <input type="hidden" class="form-control" value="<?php echo $categories_list[0]->sub_cat_id; ?>" name="sub_cat_id" >
          </div>
      </div>

      <div class="form-group form-float">
          <div class="form-line">
              <input type="text" class="form-control" value="<?php echo $categories_list[0]->sub_cat_name; ?>" name="sub_cat_name" >
