...
<?php   if(Session::has('uid')){ ?>
  ...
  <div class="modal" id="wish_view<?php echo $product_data->product_id ?>">
          ...
          <div class="product-details-inner">
            <div class="row">
              ...
              <div class="col-lg-7">
                ...
                <form class="form_validation<?php echo $product_data->product_id ?>" method="post">
                  ...
                  <div class="single-input-item">
                    <button type="button" onclick="Submit('form_validation<?php echo $product_data->product_id ?>','res<?php echo $product_data->product_id ?>')" id="submit_btn" class="sqr-btn btn btn-block">Add to wish list <img id="loader" class="loader<?php echo $product_data->product_id ?>" src="{{url('admin/assets/images/ripple.gif')}}" /></button>
                  </div>
                </form>
