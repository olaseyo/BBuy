<?php
if (!Session::has('email') || Session('utype')!=1){
    ?>
      ...
      <div class="menu">
        <ul class="list">
          ...
          <ul class="ml-menu">
              <li>
                  ...
                  <a href="{{url('/admin_product')}}" class="waves-effect waves-block">Add Product</a>
              </li>
              <li>
                  <a href="{{url('/admin_view_product')}}" class="waves-effect waves-block">View Product</a>
              </li>
          </ul>
            </li>
            ...
            <ul class="ml-menu">
                <li>
                    ...
                    <a href="{{url('/add_user')}}" class="waves-effect waves-block">Add User</a>
                </li>
                <li>
                    <a href="{{url('/admin_view_user')}}" class="waves-effect waves-block">View Users</a>
                </li>
            </ul>
              </li>
              <li>
            ...
            <li>
            <a href="{{url('/awish_list')}}" class=" waves-effect waves-block">
          ...
          <li>
          <a href="{{url('/aprice_alert')}}" class=" waves-effect waves-block">
        ...
        <ul class="ml-menu">
            <li>
                ...
                <a href="{{url('/add_category_page')}}" class="waves-effect waves-block">Add Category</a>
            </li>
            <li>
                <a href="{{url('/view_category')}}" class="waves-effect waves-block">View Category</a>
            </li>
        </ul>
          </li>
          ...
          <ul class="ml-menu">
              <li>
                  ...
                  <a href="{{url('/add_sub_category_page')}}" class="waves-effect waves-block">Add Sub Category</a>
              </li>
              <li>
                  <a href="{{url('/view_sub_category')}}" class="waves-effect waves-block">View Sub Category</a>
              </li>
          </ul>
            </li>
