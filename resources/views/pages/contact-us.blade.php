        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="contact-message">
              ...
              <form id="contact-form" action="http://demo.hasthemes.com/galio-v6/galio/assets/php/mail.php" method="post"
                class="contact-form">
                <div class="row">
          ...
          <div class="col-lg-6">
            <div class="contact-info mt-md-28 mt-sm-28">
              ...
              <ul>
                <li><i class="fa fa-fax"></i> Address : 15 Bode Thomas Street, Surulere. Lagos</li>
                <li><i class="fa fa-phone"></i> info@bestbuy.com</li>
                <li><i class="fa fa-envelope-o"></i> +2348158486068</li>
              </ul>
              <div class="working-time">
                <h3>Working hours</h3>
                <p><span>Monday – Saturday:</span>08AM – 18PM</p>
              </div>
            </div>
          </div>
        </div>
