        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <ul class="breadcrumb breadcrumb-style ">
              ...
              <li class="breadcrumb-item active">Price Alert </li>
            </ul>
          </div>
        </div>
      </div>
                ...
                <table id="tableExport" class="display table table-hover table-checkable order-column width-per-100" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <button id="del_btn{{$data->alert_id}}" onclick="DeleteWishList({{ $data->alert_id}},'del_btn{{$data->alert_id}}','DeletePriceAlert')" class="btn tblActnBtn">
