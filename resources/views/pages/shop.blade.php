            ...
            <div class="shop-sidebar-wrap mt-md-28 mt-sm-28">
              ...
              <div class="sidebar-widget mb-30">
                <div class="sidebar-category">
                  <ul>
                    ...
                    <li><a href="shop.html#">books</a><span>(10)</span></li>
                    <li><a href="shop.html#">camera</a><span>(12)</span></li>
                    <li><a href="shop.html#">computer</a><span>(08)</span></li>
                    <li><a href="shop.html#">electronic</a><span>(16)</span></li>
                    <li><a href="shop.html#">Necklaces</a><span>(11)</span></li>
                    <li><a href="shop.html#">Rugby</a><span>(20)</span></li>
                    <li><a href="shop.html#">smart phones</a><span>(15)</span></li>
                    <li><a href="shop.html#">tablet</a><span>(12)</span></li>
                    <li><a href="shop.html#">watch</a><span>(10)</span></li>
                  </ul>
                </div>
              </div>
              <!-- sidebar categorie start -->
              ...
              <div class="sidebar-widget mb-30">
                ...
                <div class="sidebar-widget-body">
                  <ul>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">calvin klein</a><span>(10)</span></li>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">diesel</a><span>(12)</span></li>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">polo</a><span>(20)</span></li>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">Tommy Hilfiger</a><span>(12)</span></li>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">Versace</a><span>(16)</span></li>
                  </ul>
                </div>
              </div>
              <!-- manufacturer end -->
                ...
                <div class="sidebar-widget-body">
                  <div class="price-range-wrap">
                    ...
                    <div class="range-slider">
                      <form action="shop.html#" class="d-flex justify-content-between">
              ...
              <div class="sidebar-widget mb-30">
                ...
                <div class="sidebar-widget-body">
                  <ul>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">s</a><span>(10)</span></li>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">m</a><span>(12)</span></li>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">l</a><span>(20)</span></li>
                    <li><i class="fa fa-angle-right"></i><a href="shop.html#">XL</a><span>(12)</span></li>
                  </ul>
                </div>
              </div>
              <!-- product size end -->
                  ...
                  <div class="col-lg-7 col-md-6">
                    <div class="top-bar-left">
                      <div class="product-view-mode mr-70 mr-sm-0">
                        ...
                        <a href="shop.html#" data-target="list"><i class="fa fa-list"></i></a>
                      </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                  ...
                  <div class="product-item fix mb-30">
                    <div class="product-thumb">
                      ...
                      <div class="product-action-link">
                        <a href="shop.html#" data-toggle="modal" data-target="#quick_view">
                          <span data-toggle="tooltip" data-placement="left" title="Quick view"><i class="fa fa-search"></i></span>
                        </a>
                        <a href="shop.html#" data-toggle="tooltip" data-placement="left" title="Wishlist"><i
                            class="fa fa-heart-o"></i></a>
                        <a href="shop.html#" data-toggle="tooltip" data-placement="left" title="Compare"><i
                            class="fa fa-refresh"></i></a>
                        <a href="shop.html#" data-toggle="tooltip" data-placement="left" title="Add to cart"><i
                  ...
                  <div class="product-list-item mb-30">
                    ...
                    <div class="product-list-content">
                      ...
                      <p>Phasellus id nisi quis justo tempus mollis sed et dui. In hac habitasse platea dictumst.
                        Suspendisse ultrices mauris diam. Nullam sed aliquet elit. Mauris consequat nisi ut mauris
                        efficitur lacinia.</p>
                      <div class="product-list-action-link">
                        <a class="buy-btn" href="shop.html#" data-toggle="tooltip"
                          data-placement="top" title="Add to cart">go to buy <i class="fa fa-shopping-cart"></i> </a>
                        <a href="shop.html#" data-toggle="modal" data-target="#quick_view">
                          <span data-toggle="tooltip" data-placement="top" title="Quick view"><i class="fa fa-search"></i></span>
                        </a>
                        <a href="shop.html#" data-toggle="tooltip" data-placement="top" title="Wishlist"><i
                            class="fa fa-heart-o"></i></a>
                        <a href="shop.html#" data-toggle="tooltip" data-placement="top" title="Compare"><i
                            class="fa fa-refresh"></i></a>
                      </div>
                    </div>
                  </div>
